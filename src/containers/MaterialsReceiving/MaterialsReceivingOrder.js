      ...
      <div key={index} style={{marginTop: 0}}>
        <Row style={{marginTop: 0}} key={'order' + index}>
          ...
          <Col span={5} style={{textAlign: 'center'}}>
            <InputNumber  max={purchaseOrderOrder.quantity - purchaseOrderOrder.quantityReceived} bordered={inputState} style={{textAlign: 'center',
              marginLeft: 0}} onChange={(e) => onQuantityChanged(e)}/>
          </Col>
