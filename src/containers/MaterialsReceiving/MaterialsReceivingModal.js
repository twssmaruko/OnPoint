...
const MaterialsReceivingModal = (props) => {
  ...
  const [selectedPurchaseOrder, setSelectedPurchaseOrder] = useState({requestedBy: 'Engr. Jojo Salamanes',
    project: '',
    vendor: '',
    status: 'pending',
    purchaseOrderNo: 0,
  ...
  const ordersToDisplay = () => {
    console.log('materialsReceivingToOrder: ', materialsReceiving);
  ...
  return (
    <Form>
      <Spin spinning={loading}>
        ...
        <Row style={{marginBottom: 0
          ...
          <Col span={6}>
            <Form.Item
              ...
              <Input style={{color: 'red'}} onChange={(e) => materialsReceivingNoChange(e.target.value)}/>
            </Form.Item>
          </Col>
        </Row>
        ...
        <Row style={{fontWeight: 'bold'}}>
          ...
          Delivered by
            ...
            <Row style={{height: 30}}>
              <Col span={24} style={{textAlign: 'center',
                fontWeight: 'bold'}}>
                <Form.Item style={{height: 25}}
                  name="deliveredBy"
                  initialValue="Engr Jojo Salamanes"
                  rules={[
                    {required: true,
                      message: 'Please input delivered by!'}
                  ]}>
                  <Input style={{height: 25}} onChange={(e) => onDeliveredBy(e.target.value)}/>
                </Form.Item>
              </Col>
            </Row>
          </Col>
            ...
            <Row style={{borderStyle: 'solid',
              ...
              <Col span={24}>
                <Form.Item style={{height: 10}}>
                  <Input onClick={() => setCalendarVisible(true)} value={dateSelected}/>
                </Form.Item>
              </Col>
            </Row>
          </Col>
          ...
          Time
            ...
            <Row>
              <Col span={24}
                ...
                <TimePicker bordered={false} format="h:mm a" onChange={(e) => onClockSelected(e)}/>
              </Col>
            </Row>
          </Col>
        </Row>
        ...
        <Row style={{fontWeight: 'bold',
          marginTop: 20}}>
          <Col span={4} style={{borderStyle: 'solid',
            textAlign: 'center',
            borderWidth: 1}}>
          P.O/Inv. No
          </Col>
          ...
          <Col span={2} style={{borderStyle: 'solid',
            textAlign: 'center',
            borderWidth: 1,
            borderLeftWidth: 0}}>
          Qty
          ...
          <Col span={3} style={{borderStyle: 'solid',
            textAlign: 'center',
            borderWidth: 1,
            borderLeftWidth: 0}}>
          Price
        ...
        <Modal visible={calendarVisible}
          ...
          <Calendar fullscreen={false} onSelect={(e) => onCalendarSelected(e)}/>
        </Modal>
      </Spin>
    </Form>
