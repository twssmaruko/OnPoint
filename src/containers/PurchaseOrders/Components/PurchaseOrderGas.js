...
const PurchaseOrderGas = (props) => {
    ...
    const [gasState] = useState(['IF-1 (MC1)', 'IF-2 (MD1)', 'IF-2 (MD2)', 'IF-3 (C/G/W/A)',
        'IF-4 (BH1)', 'IF-2 (MD3)', 'IF-1(MC3)', 'IF-5 (MC4)', 'IF-1 (MC2)', 'BT1', 'PO',
        'PU2', 'MP', 'IF-6(HR)', 'BH2', 'IF-2(MD4)', 'BT2', 'Cont']);
    const [plateNumberState] = useState(['JDO 3108', '070-103', 'GAF 9978', 
    'CMXR/GSet/WP/ATV', 'BackHoe1', 'YDY-842', 'YFB773', 'JAD-4839', 'JAB-9510', 
    '0716-555798', 'YDD-465', 'GAO-7780', '0701-829213', 'UPZ-988', 'BackHoe2', '0716-561354', 
    '0716-563487', 'Container'])
    ...
    const plateNumberList = plateNumberState.map((type, index) => (
        <Option key={'plate-' + index} value={type}>{type}</Option>
    ))

    const { openModal, purchaseRequests, projects } = useSelector(({ ui, purchaseOrder, purchaseRequests }) => ({
    ...
    const projectList = projects.map((project, index) => (
        <Option key={'project-'+index} value={project.projectCode}>{project.projectCode}</Option>
    ))
                    ...
                    <Row className='input-text-align'>
                        <Col span={24} className='input-text-align'>
                            <Row className='item-box'>
                                ...
                                <Col span={5}>
                                    <Input value={yearState} onChange={(e) => onYearChange(e.target.value)}/>
                                </Col>
                                <Col span={2}>
                                    -G
                                </Col>
                                <Col span={5}>
                                    <Input value={poNumber} onChange={(e) => onPONoChange(e.target.value)}/>
                                </Col>
                                <Col span={3} />
                            </Row>
                        </Col>
            ...
            <Row>
                ...
                <Col span={10}>
                    <Row>
                        ...
                        <Col span={16}>
                            <Select style={{ width: 100, height: 12 }} onSelect={(e) => onPRSelect(e)}>
                                {prList}
                            </Select>
                        </Col>
                    </Row>
            ...
            <Row>
                ...
                <Col span={11} className="vj-box">
                    ...
                    <Row className="vj-text">
                        ...
                        <Col span={18}>
                            <Select className="select-style" size="small" onSelect={(e) => onSelectProject(e)}>
                                {projectList}
                            </Select>
                        </Col>
                    </Row>
                    <Row className="vj-text">
                        ...
                        <Col span={18}>
                            <Select className="select-style" size="small" onSelect={(e) => onSelectGas(e)}>
                                {gasList}
                            </Select>
                        </Col>
                    </Row>
            ...
            <Row className='item-box'>
                <Col span={24}>
                    ...
                    <Row className='border-bottom'>
                        ...
                        <Col span={5} className='border-right'>
                            <Input bordered={false} className='input-text-align' value={dieselGasState} onChange={(e) => onDieselGasChange(e.target.value)}/>
                        </Col>
                        <Col span={4} className='border-right'>
                    ...
                    <Row className='border-bottom'>
                        ...
                        <Col span={5} className='border-right'>
                            <Input bordered={false} className='input-text-align' value={premiumGasState} onChange={(e) => onPremiumGasChange(e.target.value)}/>
                        </Col>
                        <Col span={4} className='border-right'>
                    ...
                    <Row className='border-bottom'>
                        ...
                        <Col span={5} className='border-right'>
                            <Input bordered={false} className='input-text-align' value={unleadedGasState} onChange={(e) => onUnleadedGasChange(e.target.value)}/>
                        </Col>
                        <Col span={4} className='border-right'>
                    ...
                    <Row className='border-bottom'>
                        ...
                        <Col span={5} className='border-right'>
                            <Input bordered={false} className='input-text-align' value={dieselOilState} onChange={(e) => onDieselOilChange(e.target.value)}/>
                        </Col>
                        <Col span={4} className='border-right'>
